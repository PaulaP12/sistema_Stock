  ...
  <div id="app">
    ...
    <nav>
      <div class="nav-wrapper">
        <a class="brand-logo" style="margin-left:30px;font-size:25px;"><router-link to="/"><font-awesome-icon :icon="['fas','boxes']"/> SISTEMA STOCK</router-link></a>
...
<style>
	.nav-wrapper{background-color:#476F7E;}
</style>
